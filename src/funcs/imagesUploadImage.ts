 ...
 */
export function imagesUploadImage(
  client: ImgsrcCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.UploadImageRequestBody$outboundSchema),
        value,
      ),
  ...
  if (payload != null) {
    ...
    if (payload?.target_path !== undefined) {
      appendForm(body, "target_path", payload?.target_path);
    }
  }
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "409", "413", "4XX", "500", "5XX"],
  ...
  >(
    ...
    M.jsonErr([400, 401, 409, 413], errors.ErrorResponse$inboundSchema),
